...
class EmbeddingMLP(nn.Module):
    def __init__(self, categorial_feature_vocabsize, continous_feature_names, categorial_feature_names, use_gpu, embed_dim=10, hidden_dim=[128, 128]):
        super().__init__()
    ...
    def forward(self, xi, xv):
        ...
        for i, embed_layer in enumerate(self.embedding_layer_list):
            if self.use_gpu:
                embed_out = embed_layer.cuda()(xv[:, i].long())
            else:

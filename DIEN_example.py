...
if __name__ == "__main__":
    ...
    # train model
    model = DIEN(len(candidate_movie_col), len(recent_rate_col), len(user_profile_col), len(context_features_col), 
        candidate_movie_dict, recent_rate_dict, user_profile_dict, context_feature_dict, 5, 32, 64)
